  ...
  return (
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
        ...
        <div className='px-2 flex justify-between items-center w-full h-full'>
            ...
            <div className='flex items-center'>
                ...
                <ul className='hidden md:flex'>
                    ...
                    <li className='cursor-pointer'><Link to='platforms' smooth={true} offset={-120} duration={500}>Platforms</Link></li>
        ...
        <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
            ...
            <li className='cursor-pointer border-b-2 border-zinc-300 w-full'><Link onClick={handleClose} to='about' smooth={true} offset={-200} duration={500}>About</Link></li>
            <li className='cursor-pointer border-b-2 border-zinc-300 w-full'><Link onClick={handleClose} to='support' smooth={true} offset={-50} duration={500}>Support</Link></li>
            <li className='cursor-pointer border-b-2 border-zinc-300 w-full'><Link onClick={handleClose} to='platforms' smooth={true} offset={-120} duration={500}>Platforms</Link></li>
